  ...
  return (
    <div className="middle2-main">
      <span className="middle-2-tagline">
        An&nbsp;
        <span className="bold-font">IMPRESSIVE</span>
        &nbsp;gem in the heart of&nbsp;
        <span className="bold-font">AMSTERDAM.</span> &nbsp;industrial, fresh,
        innovative and the love for&nbsp;
        <span className="bold-font">DETAIL</span>
        &nbsp;and&nbsp;
        <span className="bold-font">HISTORY</span>
